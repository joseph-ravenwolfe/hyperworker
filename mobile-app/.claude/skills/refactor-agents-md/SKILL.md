...
description: Refactor an AGENTS.md file to follow progressive disclosure principles
---
...
3. **Group the rest**: Organize remaining instructions into logical categories (e.g., Swift/Kotlin conventions, testing patterns, API design, Git workflow). For each group, create a separate markdown file.
